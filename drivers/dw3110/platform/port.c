...
#include <drivers/dw3110/deca_spi.h>
...
#define IRQ_GPIO_PORT      DT_LABEL(DT_PHANDLE_BY_IDX(DT_NODELABEL(spi2), int-gpios, 0))
#define IRQ_GPIO_PIN       DT_PHA(DT_NODELABEL(spi2), int-gpios, pin)
#define IRQ_GPIO_FLAGS     DT_PHA(DT_NODELABEL(spi2), int-gpios, flags)

#define WAKEUP_GPIO_PORT   DT_LABEL(DT_PHANDLE_BY_IDX(DT_NODELABEL(spi2), dwm_wakeup_gpios, 0))
#define WAKEUP_GPIO_PIN    DT_PHA(DT_NODELABEL(spi2), dwm_wakeup_gpios, pin)
#define WAKEUP_GPIO_FLAGS  DT_PHA(DT_NODELABEL(spi2), dwm_wakeup_gpios, flags)

#define RESET_GPIO_PORT    DT_LABEL(DT_PHANDLE_BY_IDX(DT_NODELABEL(spi2), reset-gpios, 0))
#define RESET_GPIO_PIN     DT_PHA(DT_NODELABEL(spi2), reset-gpios, pin)
#define RESET_GPIO_FLAGS   DT_PHA(DT_NODELABEL(spi2), reset-gpios, flags)

#define RX_LED_GPIO_PORT   DT_LABEL(DT_PHANDLE_BY_IDX(DT_NODELABEL(spi2), dwm_rx_led_gpios, 0))
#define RX_LED_GPIO_PIN    DT_PHA(DT_NODELABEL(spi2), dwm_rx_led_gpios, pin)
#define RX_LED_GPIO_FLAGS  DT_PHA(DT_NODELABEL(spi2), dwm_rx_led_gpios, flags)

#define TX_LED_GPIO_PORT   DT_LABEL(DT_PHANDLE_BY_IDX(DT_NODELABEL(spi2), dwm_tx_led_gpios, 0))
#define TX_LED_GPIO_PIN    DT_PHA(DT_NODELABEL(spi2), dwm_tx_led_gpios, pin)
#define TX_LED_GPIO_FLAGS  DT_PHA(DT_NODELABEL(spi2), dwm_tx_led_gpios, flags)

#define IRQ_GPIO_PORT      DT_LABEL(DT_PHANDLE_BY_IDX(DT_NODELABEL(spi2), dwm_irq_gpios, 0))
#define IRQ_GPIO_PIN       DT_PHA(DT_NODELABEL(spi2), dwm_irq_gpios, pin)
#define IRQ_GPIO_FLAGS     DT_PHA(DT_NODELABEL(spi2), dwm_irq_gpios, flags)

#define POL_GPIO_PORT      DT_LABEL(DT_PHANDLE_BY_IDX(DT_NODELABEL(spi2), dwm_spi_pol_gpios, 0))
#define POL_GPIO_PIN       DT_PHA(DT_NODELABEL(spi2), dwm_spi_pol_gpios, pin)
#define POL_GPIO_FLAGS     DT_PHA(DT_NODELABEL(spi2), dwm_spi_pol_gpios, flags)

#define PHA_GPIO_PORT      DT_LABEL(DT_PHANDLE_BY_IDX(DT_NODELABEL(spi2), dwm_spi_pha_gpios, 0))
#define PHA_GPIO_PIN       DT_PHA(DT_NODELABEL(spi2), dwm_spi_pha_gpios, pin)
#define PHA_GPIO_FLAGS     DT_PHA(DT_NODELABEL(spi2), dwm_spi_pha_gpios, flags)
